...
class ImageCaptcha(_Captcha):
    ...
    def truefonts(self):
        ...
        self._truefonts = tuple([
            truetype(font=BytesIO(open(n, "rb").read()), size=s)
    ...
    def create_captcha_image(self, chars, color, background):
        ...
        # image = Image.new('RGB', (self._width + 2 * self._pad_width, self._height + 2 * self._pad_height), background)
        draw = Draw(image)
        ...
        width = max(text_width + 2 * self._pad_width, self._width)
